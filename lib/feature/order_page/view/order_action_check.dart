...
extension OrderActionCheck on Order {
  ...
  bool canAcceptCarrierOffer(User? user) =>
      _canChangeCarrierOfferStatus(user, true);
  bool canDeclineCarrierOffer(User? user) =>
      _canChangeCarrierOfferStatus(user, false);
