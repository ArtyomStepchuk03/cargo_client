...
class ScrollableForm extends StatefulWidget {
  ...
  ScrollableForm({Key? key, this.padding, required this.children})
      : super(key: key);

  static ScrollableFormState? of(BuildContext context) {
    return context
        .dependOnInheritedWidgetOfExactType<_ScrollableFormScopeWidget>()
        ?.state;
  }
  ...
  bool? validate() {
    ...
    if (_attentionFieldState != null) {
      _scrollController.position
          .ensureVisible(_attentionFieldState!.context.findRenderObject()!);
...
class _ScrollableFormScopeWidget extends InheritedWidget {
  ...
  const _ScrollableFormScopeWidget(
