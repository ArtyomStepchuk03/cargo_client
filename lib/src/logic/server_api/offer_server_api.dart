...
class OfferServerAPI {
  ...
  parse.LiveQuerySubscription<Offer?> subscribeToChanges(Offer? offer) =>
      serverManager.liveQueryManager!.subscribeToObjectChanges(
          Offer.className, offer?.id, (decoder) => Offer.decode(decoder)!);
  void unsubscribe(parse.LiveQuerySubscription<Offer?> subscription) =>
