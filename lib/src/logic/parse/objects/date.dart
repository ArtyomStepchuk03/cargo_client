...
Map<String, dynamic>? jsonFromDate(DateTime? date) {
  ...
  return {typeKey: 'Date', 'iso': stringFromDate(date)};
}

DateTime dateFromString(String string) => DateTime.parse(string);

String stringFromDate(DateTime date) => date.toIso8601String();
