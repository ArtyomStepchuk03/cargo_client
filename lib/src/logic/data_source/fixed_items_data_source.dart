...
class FixedItemsDataSource<T> implements DataSource<T> {
  ...
  Future<DataPortion<T?>> loadPortion(dynamic token, int suggestedLimit) async {
    ...
    if (token == null) {
      return DataPortion(fixedItems + portion.items!,
          nextPortionToken: portion.nextPortionToken,
          finished: portion.finished);
    }
    return portion;
  }
  ...
  bool operator ==(dynamic other) {
    ...
    return base == otherSource.base &&
        ListEquality().equals(fixedItems, otherSource.fixedItems);
  }

  @override
  int get hashCode => Object.hash(base, fixedItems);
}
