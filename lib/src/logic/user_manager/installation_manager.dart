...
class InstallationManager {
  ...
  Future<void> registerDevice(
      PushNotificationClient? pushNotificationClient, User? user) async {
  ...
  factory InstallationManager.standard(InstallationServerAPI serverAPI) =>
      InstallationManager(serverAPI, InstallationStorage());
