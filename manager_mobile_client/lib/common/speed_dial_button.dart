...
class SpeedDialButtonItem {
  ...
  SpeedDialButtonItem({this.label, this.icon, this.onPressed});
}
...
class SpeedDialButton extends StatelessWidget {
  ...
  SpeedDialButton({this.icon, this.label, this.backgroundColor, this.items});
...
class _SpeedDialPopupRoute extends PopupRoute<void> {
  ...
  _SpeedDialPopupRoute({this.items, this.buttonBackgroundColor, String barrierLabel}) : _barrierLabel = barrierLabel;
  ...
  Widget _buildItemButton(BuildContext context, SpeedDialButtonItem item, int index) {
    return buildFloatingActionButtonContainer(
      child: Row(
        mainAxisAlignment: MainAxisAlignment.end,
        children: [
          ...
          _buildTransition(
            Container(
              width: floatingActionButtonHeight, height: floatingActionButtonHeight,
  ...
  Widget _buildTransition(Widget child, Animation<double> animation, int index) {
  ...
  Widget _buildLabelContainer({Widget child}) {
    return Container(
