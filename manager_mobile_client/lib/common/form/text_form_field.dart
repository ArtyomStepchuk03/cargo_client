...
class CustomTextFormField extends FormField<String> {
  ...
  CustomTextFormField({
    ...
    validator: validator,
    enabled: enabled,
    builder: (FormFieldState<String> state) => _buildForState(state,
      label: label,
      inputType: inputType,
  ...
  static Widget _buildForState<T>(CustomTextFormFieldState state, {
    ...
    if (state.loading) {
      return buildLoadingTextField(context: state.context, text: state.value, label: label, enabled: enabled);
    }
    return TextField(
      controller: state.controller,
      focusNode: state.focusNode,
      decoration: buildCustomInputDecoration(context: state.context, label: label, errorText: state.errorText, enabled: enabled),
