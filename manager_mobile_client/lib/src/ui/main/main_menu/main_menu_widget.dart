...
import 'package:manager_mobile_client/src/ui/reservation/reservation_list_strings.dart' as reservation_list_strings;
import 'package:manager_mobile_client/src/ui/order/order_list_strings.dart' as order_list_strings;
import 'package:manager_mobile_client/src/ui/customer/customer_list_strings.dart' as customer_list_strings;
import 'package:manager_mobile_client/src/ui/supplier/supplier_list_strings.dart' as supplier_list_strings;
import 'package:manager_mobile_client/src/ui/transport_unit/transport_unit_tab_strings.dart' as transport_unit_tab_strings;
import 'package:manager_mobile_client/src/ui/message/message_list_strings.dart' as message_list_strings;
import 'package:manager_mobile_client/src/ui/customer/customer_details/customer_my_data_strings.dart' as customer_my_data_strings;
...
class MainMenuWidget extends StatelessWidget {
  ...
  List<Widget> _buildItems(BuildContext context) {
    ...
    return [
      ...buildMainScreens(user).map((screen) => _buildItemForScreen(context, screen)),
      _buildItem(context: context, icon: Icons.exit_to_app, title: strings.logOut, onTap: () => _logOut(context)),
    ];
  }

  Widget _buildItemForScreen(BuildContext context, MainScreen mainScreen) {
    switch (mainScreen) {
      case MainScreen.reservations: return _buildItem(
        context: context, mainScreen: mainScreen,
        icon: Icons.table_view,
        title: reservation_list_strings.title,
        onTap: () => _showScreen(context, mainScreen),
      );
      case MainScreen.orders: return _buildItem(
        context: context, mainScreen: mainScreen,
        icon: Icons.departure_board,
        title: order_list_strings.title,
        onTap: () => _showScreen(context, mainScreen),
      );
      case MainScreen.customers: return _buildItem(
        context: context, mainScreen: mainScreen,
        icon: Icons.assignment_ind,
        title: customer_list_strings.title,
        onTap: () => _showScreen(context, mainScreen),
      );
      case MainScreen.suppliers: return _buildItem(
        context: context, mainScreen: mainScreen,
        icon: Icons.warehouse,
        title: supplier_list_strings.title,
        onTap: () => _showScreen(context, mainScreen),
      );
      case MainScreen.transportUnits: return _buildItem(
        context: context, mainScreen: mainScreen,
        icon: Icons.people,
        title: transport_unit_tab_strings.title,
        onTap: () => _showScreen(context, mainScreen),
      );
      case MainScreen.messages: return _buildItem(
        context: context, mainScreen: mainScreen,
        icon: Icons.message,
        title: message_list_strings.title,
        onTap: () => _showScreen(context, mainScreen),
      );
      case MainScreen.myData: return _buildItem(
        context: context, mainScreen: mainScreen,
