...
class ListCard extends StatelessWidget {
  ...
  ListCard({this.backgroundColor, this.highlightColor, this.children, this.expandedWidget, this.onTap});

  Widget build(BuildContext context) {
    return Card(
      color: backgroundColor,
      shape: RoundedRectangleBorder(
        side: highlightColor != null ? BorderSide(color: highlightColor) : BorderSide(style: BorderStyle.none),
...
class SelectableListCard extends StatelessWidget {
  ...
  SelectableListCard({this.children, this.checked = false, this.onTap});
  ...
  Widget _buildCheckmark(BuildContext context, bool checked) {
    return Container(
      ...
      child: checked ? Icon(Icons.check_box, color: Theme.of(context).primaryColor,) : Icon(Icons.check_box_outline_blank, color: Colors.grey),
    );
  }
}
...
class ListCardField extends StatelessWidget {
  ...
  ListCardField({this.name, this.value, this.textColor = Colors.black});
...
Widget _buildListCardContent({List<Widget> children}) {
  return Padding(
