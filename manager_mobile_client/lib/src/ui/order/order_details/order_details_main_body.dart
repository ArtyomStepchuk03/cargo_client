    ...
    return buildFormGroup([
      if (widget.user.canManageOrderSalePrice()) ...[
        ...
        buildFormRow(
          ...
          buildCustomNumberFormField(
            ...
            label: strings.saleTariff,
            validator: NumberValidator(decimal: true, minimum: 0),
            enabled: _editing,
          ),
        ),
      ],
      buildFormRow(
        ...
        EnumerationFormField<PriceType>(
          ...
          values: PriceType.values,
          formatter: formatPriceTypeSafe,
          label: strings.deliveryPriceType,
          validator: RequiredValidator(),
          enabled: _editing,
        ),
      ),
