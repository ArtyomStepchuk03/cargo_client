...
void showOrderSearch({BuildContext context, User user, OrderFilter filter, FilterPredicate<Order> filterPredicate, OrderSort sort}) {
  showCustomSearch(
    context: context,
    builder: (BuildContext context, String query) {
      ...
      if (query != null) {
        filterPredicates.add(OrderSearchFilterPredicate(user, query));
      }
