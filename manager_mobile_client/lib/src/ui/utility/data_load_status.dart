class DataLoadStatus<R, E> {
  ...
  DataLoadStatus.succeeded(R result) : _internal = _DataLoadInternalStatus.succeeded, _result = result;
  DataLoadStatus.failed([E exception]) : _internal = _DataLoadInternalStatus.failed, _exception = exception;
