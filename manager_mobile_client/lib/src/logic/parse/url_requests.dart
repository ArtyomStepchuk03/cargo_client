...
Future<dynamic> getById(Server server, String relativeUrl, String id, {List<String> include}) async {
...
Future<Map<String, dynamic>> getObjectById(Server server, String relativeUrl, String id, {List<String> include}) async {
...
Future<Map<String, dynamic>> getObjectForMe(Server server, String relativeUrl) async {
...
Future<dynamic> create(Server server, String relativeUrl, dynamic body, {String contentType}) async {
  return await server.performPost(relativeUrl, body: body, contentType: contentType);
}

Future<String> createObject(Server server, String relativeUrl, Map<String, dynamic> data) async {
  final requestBody = json.encode(data);
  final responseBody = await create(server, relativeUrl, requestBody, contentType: contentTypeJson);
...
Future<void> update(Server server, String relativeUrl, String id, dynamic body, {String contentType}) async {
  await server.performPut('$relativeUrl/$id', body: body, contentType: contentType);
}

Future<void> updateObject(Server server, String relativeUrl, String id, Map<String, dynamic> data) async {
  final requestBody = json.encode(data);
  await update(server, relativeUrl, id, requestBody, contentType: contentTypeJson);
}
...
Future<dynamic> call(Server server, String relativeUrl, [Map<String, dynamic> parameters]) async {
  String requestBody;
  if (parameters != null) {
