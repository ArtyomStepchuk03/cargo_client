...
class UserManager {
  ...
  factory UserManager.standard(ServerManager serverManager, UserServerAPI serverAPI) => UserManager(serverManager, serverAPI, UserStorage());

  static const _allowedRoles = {Role.manager, Role.administrator, Role.logistician, Role.dispatcher, Role.customer};
