...
class Encoder {
  ...
  void encodeSessionToken(String value) => encodeString(parse.sessionTokenKey, value);
  void encodeDeviceToken(String value) => encodeString(parse.deviceTokenKey, value);
  ...
  void encodeDate(String key, DateTime value) => _data[key] = parse.jsonFromDate(value);
  void encodeCoordinate(String key, LatLng value) => _data[key] = parse.jsonFromCoordinate(value);

  void encodeMap(String key, Map<String, dynamic> map) => _data[key] = map;
  void encodeFile(String key, RemoteFile file) => _data[key] = parse.jsonFromFile(file);
  void encodePointer(String key, String className, String id) => _data[key] = parse.jsonForPointer(className, id);

  void encodeUserPointer(String key, String id) => encodePointer(key, parse.userClassName, id);
...
class ListEncoder {
  ...
  void addCoordinate(LatLng value) => _data.add(parse.jsonFromCoordinate(value));

  void addMap(Map<String, dynamic> value) => _data.add(value);
  void addFile(RemoteFile file) => _data.add(parse.jsonFromFile(file));
  void addPointer(String className, String id) => _data.add(parse.jsonForPointer(className, id));
