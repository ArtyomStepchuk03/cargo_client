...
class ChangeEncoder implements Encoder {
  ...
  ListEncoder getAddOperationListEncoder(String key) => encoder.getAddOperationListEncoder(key);
  ListEncoder getRemoveOperationListEncoder(String key) => encoder.getRemoveOperationListEncoder(key);
}
