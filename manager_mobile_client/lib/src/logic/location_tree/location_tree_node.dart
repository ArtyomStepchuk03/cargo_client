...
class LocationTreeNode<T extends LocationTreeItem> {
  ...
  LocationTreeNode(this.southwest, this.northwest, this.northeast, this.southeast) : items = null;
  LocationTreeNode.leaf(this.items) : northwest = null, northeast = null, southeast = null, southwest = null;
}
