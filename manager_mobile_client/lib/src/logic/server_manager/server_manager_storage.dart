...
class ServerManagerStorage {
  ...
  Future<void> setServerConfiguration(parse.ServerConfiguration serverConfiguration) async {
  ...
  parse.ServerConfiguration _decode(String jsonString) {
    ...
    if (baseUrl is! String || applicationId is! String || clientKey is! String) {
      return null;
    }
    return parse.ServerConfiguration(baseUrl: baseUrl, applicationId: applicationId, clientKey: clientKey);
  }

  static const _serverConfigurationKey = 'com.macsoftex.CargoDeal.ServerManagerStorage.serverConfiguration';
}
