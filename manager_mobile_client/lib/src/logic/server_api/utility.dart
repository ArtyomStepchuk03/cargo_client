...
Future<void> markDeleted(parse.Server server, String className, String id) async {
...
Future<Map<String, dynamic>> callCloudFunction(parse.Server server, String functionName, [Map<String, dynamic> parameters]) async {
