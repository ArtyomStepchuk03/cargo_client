...
class UnloadingPoint extends Identifiable<String> implements DeletionMarking {
  ...
  factory UnloadingPoint.decode(Decoder decoder) {
    ...
    decoded.entrances = decoder.decodeObjectList('entrances', (Decoder decoder) => Entrance.decode(decoder))?.excludeDeleted();
    decoded.equipmentRequirements = VehicleEquipment.decode(decoder.decodeMap('equipmentRequirements'));
