...
class Supplier extends Identifiable<String> implements DeletionMarking {
  ...
  factory Supplier.decode(Decoder decoder) {
    ...
    decoded.articleBrands = decoder.decodeObjectList('articleBrands', (Decoder decoder) => ArticleBrand.decode(decoder))?.excludeDeleted();
    decoded.loadingPoints = decoder.decodeObjectList('loadingPoints', (Decoder decoder) => LoadingPoint.decode(decoder))?.excludeDeleted();
