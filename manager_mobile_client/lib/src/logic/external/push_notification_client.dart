...
typedef PushNotificationHandler = void Function(PushNotification notification, bool active);
...
class PushNotificationClient {
  ...
  void removeHandler(PushNotificationHandler handler) => _handlers.remove(handler);
  ...
  Future<String> getToken() async {
    return await _underlying.getToken().timeout(Duration(milliseconds: 2000), onTimeout: () async => null);
  }
  ...
  PushNotificationAlert _convertNotification(RemoteNotification notification) {
