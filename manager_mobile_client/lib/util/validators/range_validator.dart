...
extension HourRangeBeginValidator on RangeBeginValidator {
  static RangeBeginValidator build(GlobalKey<FormFieldState<String>> endKey, String errorString) => RangeBeginValidator(_compareHourStrings, endKey, errorString);
}

extension HourRangeEndValidator on RangeEndValidator {
  static RangeEndValidator build(GlobalKey<FormFieldState<String>> endKey, String errorString) => RangeEndValidator(_compareHourStrings, endKey, errorString);
}
